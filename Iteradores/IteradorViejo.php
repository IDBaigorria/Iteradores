...
class Iterador extends Objeto{
	...
	/*	NOTAS DE CLASE:
			...
			SOBRE LA CREACION Y VALIDACION DE NODOS
				Para insertar nuevos nodos a la clase siempre es conveniente crearlos en la misma clase para asegurar la compatibilidad entre el iterador y la estructura de nodos que se va generano.
	...
	*/
	...
	//------------------------------------------------------------------------------->
		...
		/*FUNCION STATIC PROTECTED registrar_clase($iterador)-------------------------->
			...
			+--------------------------------------------
				Notas: (V1.9.3) Los iteradores deben permitir ser cargados solamente desde la misma subclase (clses hijas de esta) que fue creado. Para solucionarlo vamos a guardar en el nodo "raiz_cuerpo" del iterador un enlace a un nodo que contenga el nombre de la clase.
